...
public class DoctorJdbcDao implements DoctorDao {
    ...
    public Doctor getByName(String name, String last_name) {
    ...
    public List<Doctor> getBySpeciality(Integer speciality_id) {
    ...
    private class DoctorRowMapper implements RowMapper<Doctor>{
        ...
        public Doctor mapRow(ResultSet rs, int rowNum) throws SQLException {
            final List<Speciality> specialities = specialityDao.getByDoctorId(rs.getInt(ID_COL));
